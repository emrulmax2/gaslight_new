...
class GasCommissionDecommissionRecord extends Model
{
    ...
    public function appliance(){
        return $this->hasMany(GasCommissionDecommissionRecordAppliance::class, 'gas_commission_decommission_record_id', 'id')->orderBy('id', 'ASC');
    }

...
class GasLandlordSafetyRecordAppliance extends Model
{
    ...
    public function gsr(){
        return $this->belongsTo(GasLandlordSafetyRecord::class, 'gas_landlord_safety_record_id');
    }

...
class GasUnventedHotWaterCylinderRecord extends Model
{
    ...
    public function system(){
        return $this->hasOne(GasUnventedHotWaterCylinderRecordSystem::class, 'gas_unvented_hot_water_cylinder_record_id', 'id');
    }

    public function inspection(){
        return $this->hasOne(GasUnventedHotWaterCylinderRecordInspection::class, 'gas_unvented_hot_water_cylinder_record_id', 'id');
    }

...
class GasBoilerSystemCommissioningChecklist extends Model
{
    ...
    public function appliance(){
        return $this->hasMany(GasBoilerSystemCommissioningChecklistAppliance::class, 'gas_boiler_system_commissioning_checklist_id', 'id')->orderBy('id', 'ASC');
    }

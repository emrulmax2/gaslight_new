...
class GasPowerFlushRecord extends Model
{
    ...
    public function checklist(){
        return $this->hasOne(GasPowerFlushRecordChecklist::class, 'gas_power_flush_record_id', 'id');
    }

    public function rediators(){
        return $this->hasMany(GasPowerFlushRecordRediator::class, 'gas_service_record_id', 'id')->orderBy('id', 'ASC');
    }

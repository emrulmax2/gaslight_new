    ...
    public function getDetails($record_id){
        try {
            ...
            if(empty($commission_decommision->certificate_number)):
                ...
                $userLastCertificate = GasCommissionDecommissionRecord::where('job_form_id', $form->id)->where('created_by', $user_id)->where('id', '!=', $commission_decommision->id)->orderBy('id', 'DESC')->get()->first();

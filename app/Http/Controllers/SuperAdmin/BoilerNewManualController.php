...
class BoilerNewManualController extends Controller
{
    /**
     ...
     */
    public function show(BoilerNewManual $boilerManual)
    {
        //
    }
     ...
     */
    public function edit(BoilerNewManual $boilerManual)
    {
    ...
    {
        $boilerManual = BoilerNewManual::withTrashed()->find($id);
    ...
    public function list(Request $request) {
        ...
        $query = BoilerNewManual::orderByRaw(implode(',', $sorts));

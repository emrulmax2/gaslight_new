                                ...
                                @if(isset($record->available_options->appliances) && !empty($record->available_options->appliances))
                                    @foreach($record->available_options->appliances as $appliance)
                                        <tr>
                                            ...
                                            <td class="border-primary text-primary pl-2 pr-2 py-05 text-12px tracking-normal text-center leading-1-2 border-b border-r">{{ (isset($appliance->other_issue) && $appliance->other_issue == 'Yes' && isset($appliance->other_issue_details) && !empty($appliance->other_issue_details) ? $appliance->other_issue_details : 'No') }}</td>

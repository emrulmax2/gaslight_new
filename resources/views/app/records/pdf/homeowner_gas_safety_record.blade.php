                                ...
                                @if(isset($record->available_options->appliances) && !empty($record->available_options->appliances))
                                    @foreach($record->available_options->appliances as $appliance)
                                        <tr>
                                            ...
                                            <td class="border-primary text-primary pl-2 pr-2 py-05 text-12px tracking-normal text-center leading-1-5 border-b border-r">{{ (isset($appliance->tappliance_type_id) && $appliance->tappliance_type_id > 0 ? typeName($appliance->tappliance_type_id) : '') }}</td>

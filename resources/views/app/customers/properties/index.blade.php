    ...
    <div class="intro-y box mt-5 p-5">
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            ...
            <div class="mt-5 flex sm:mt-0">
                <x-base.button type="button" data-customerid="{{ $customer->id }}" data-tw-toggle="modal" data-tw-target="#addCustomerPropertyModal" class="addCustomerPropertyBtn w-auto" variant="primary" >
                    <x-base.lucide class="mr-2 h-4 w-4" icon="plus-circle" /> Add Address
                </x-base.button>
        ...
        <div class="scrollbar-hidden overflow-x-auto">
            <div class="mt-5" data-customerid="{{ $customer->id }}" id="customerPropertyListTable" ></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
    @include('app.customers.properties.show-modals')
...
@pushOnce('scripts')
    ...
    @vite('resources/js/app/properties.js')
@endPushOnce
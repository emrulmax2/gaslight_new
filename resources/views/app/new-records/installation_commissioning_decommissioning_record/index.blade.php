...
@section('subcontent')
        ...
        <div class="intro-y box mt-2 bg-slate-200 rounded-none border-none px-2 pb-2">
            ...
            <div class="px-2 py-3 applianceWrap bg-white">
                <a href="javascript:void(0);" class="flex justify-between items-center cursor-pointer applianceBlock">
                    <div>
                        <div class="text-slate-500 mt-1 font-medium text-xs leading-none mb-1 uppercase theLabel">Commissioning / Decommissioning Record</div>
                        <div class="theDesc">0/5</div>
                    </div>
                    <span style="flex: 0 0 16px; margin-left: 20px;"><x-base.lucide class="h-4 w-4 text-success" icon="chevron-right" /></span>
                </a>
            </div>
    ...
    @include('app.new-records.installation_commissioning_decommissioning_record.modal')
...
@pushOnce('scripts')
    ...
    @vite('resources/js/app/new-records/installation-commissioning-decommissioning-record.js')
@endPushOnce
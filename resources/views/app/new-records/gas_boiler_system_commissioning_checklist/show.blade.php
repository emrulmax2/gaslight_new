            ...
            <div class="intro-y col-span-12 max-sm:mt-5 sm:col-span-2 order-2 sm:order-1">
                <div class="sticky top-0">
                    <div class="flex flex-col justify-center items-center shadow-md rounded-md bg-white p-5">
                        <x-base.button data-id="{{ $gbscc->id }}" type="button" class="editRecordBtn w-full mb-2 border-0 cursor-pointer text-slate-500 shadow-none [&.active]:bg-[#164e63] [&.active]:text-white hover:bg-[#164e63] focus:bg-[#164e63] hover:text-white focus:text-white">
...
@pushOnce('scripts')
    @vite('resources/js/app/new-records/gas_boiler_system_commissioning_checklist_show.js')
@endPushOnce
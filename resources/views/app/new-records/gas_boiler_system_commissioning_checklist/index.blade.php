...
@section('subcontent')
        ...
        <div class="intro-y box mt-2 bg-slate-200 rounded-none border-none px-2 pb-2">
            ...
            <div class="px-2 py-3 applianceWrap bg-white">
                <a href="javascript:void(0);" class="flex justify-between items-center cursor-pointer applianceBlock">
                    <div>
                        <div class="text-slate-500 mt-1 font-medium text-xs leading-none mb-1 uppercase theLabel">Appliance</div>
    ...
    @include('app.new-records.gas_boiler_system_commissioning_checklist.modal')
...
@pushOnce('scripts')
    ...
    @vite('resources/js/app/new-records/gas-boiler-system-commissioning-checklist.js')
@endPushOnce
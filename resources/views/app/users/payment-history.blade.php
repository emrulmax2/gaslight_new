...
@section('subcontent')
    <div class="intro-y mt-8 flex items-center flex-row">
        <h2 class="mr-auto text-lg font-medium">{{ $user->name.'\'s Payment Historys'}}</h2>
    ...
    <div class="intro-y box mt-5 p-3 sm:p-5">
        ...
        <div class="scrollbar-hidden overflow-x-auto">
            <div class="mt-3 sm:mt-5 gca_responsive" data-userid="{{ $user->id }}" id="subscriptionListTable" ></div>
        </div>
    </div>
...
@pushOnce('scripts')
    @vite('resources/js/app/users/subscription.js')
@endPushOnce

    ...
    <x-base.dialog.panel class="rounded-none">
        <form method="post" action="#" id="customerJobAddressForm">
            ...
            <x-base.dialog.description class="bg-slate-200">
                <a href="javascript:void(0);" data-customer-id="0" data-type="" class="addJobAddressBtn text-primary flex justify-between items-center p-3 bg-white mb-2 text-base">Add New Address<x-base.lucide class="ml-auto h-4 w-4" icon="plus-circle" /></a>
...
<x-base.dialog id="quoteDiscountModal" size="sm" class="max-w-full">
    <x-base.dialog.panel class="rounded-none">

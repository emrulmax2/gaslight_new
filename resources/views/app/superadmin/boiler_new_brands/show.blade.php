...
@section('subcontent')
    ...
    <div class="intro-y box mt-5 p-3 sm:p-5">
        ...
        <div class="scrollbar-hidden overflow-x-auto">
            <div class="mt-5" id="boilerBrandListTable" data-boiler_new_brand_id="{{ $boilerBrand->id }}"></div>
        </div>
    </div>

    @include('app.superadmin.boiler_new_manuals.modal')
...
@pushOnce('scripts')
    @vite('resources/js/app/boiler-new-manuals/list.js')
    @vite('resources/js/app/boiler-new-manuals/crud.js')
    @vite('resources/js/app/boiler-new-manuals/dropzone.js')
@endPushOnce
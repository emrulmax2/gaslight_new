...
@section('subcontent')
                ...
                <div class="p-5">
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        ...
                        <div class="mt-5 flex sm:mt-0 max-sm:hidden">
                            <x-base.button type="button" data-tw-toggle="modal" data-tw-target="#addPaymentMethodModal" class="shadow-md add_btn" variant="primary" >
                    ...
                    <div class="scrollbar-hidden overflow-x-auto">
                        <div class="mt-3 sm:mt-5 gca_responsive" id="paymentMethodList" ></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('app.superadmin.settings.payment-method.index-modals')
...
@pushOnce('scripts')
    @vite('resources/js/app/superadmin/settings/payment-method.js')
@endPushOnce

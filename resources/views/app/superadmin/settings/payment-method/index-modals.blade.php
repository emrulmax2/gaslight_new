<!-- BEGIN: Modal Content -->
<x-base.dialog id="addPaymentMethodModal" staticBackdrop>
    <x-base.dialog.panel>
        <form method="post" action="#" id="addReferralCodeForm">
            ...
            <x-base.dialog.footer>
                ...
                <x-base.button class="w-auto" id="savePMBtn" type="submit" variant="primary">
...
<!-- BEGIN: Modal Content -->
<x-base.dialog id="editPaymentMethodModal" staticBackdrop>
    <x-base.dialog.panel>
        <form method="post" action="#" id="editPaymentMethodForm">
            <x-base.dialog.title>
                <h2 class="mr-auto text-base font-medium">Update Payment method</h2>
                <a class="absolute right-0 top-0 mr-3 mt-3" data-tw-dismiss="modal" href="#" ><x-base.lucide class="h-6 w-6 text-slate-400" icon="X" /></a>
            </x-base.dialog.title>
            <x-base.dialog.description>
                <div>
            ...
            <x-base.dialog.footer>
                ...
                <x-base.button class="mr-1 w-20" data-tw-dismiss="modal" type="button" variant="outline-secondary" ><x-base.lucide class="mr-2 h-4 w-4" icon="x-circle" />Cancel </x-base.button>
                <x-base.button class="w-auto" id="editPMBtn" type="submit" variant="primary">
                    <x-base.lucide class="mr-2 h-4 w-4" icon="check-circle" />
                    Update
                    <x-base.loading-icon style="display: none;" class="ml-2 h-4 w-4 theLoader" color="#FFFFFF" icon="oval" />
                </x-base.button>

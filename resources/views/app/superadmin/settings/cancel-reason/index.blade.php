        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Job Cancel Reasons</h2>
                </div>
                <div class="p-5">
                    ...
                    <div class="scrollbar-hidden overflow-x-auto">
                        <div class="mt-3 sm:mt-5 gca_responsive" id="cancellReasonList" ></div>
                    </div>
                </div>
            </div>
        </div>
...
@pushOnce('scripts')
    @vite('resources/js/app/superadmin/settings/cancel-reason.js')
@endPushOnce
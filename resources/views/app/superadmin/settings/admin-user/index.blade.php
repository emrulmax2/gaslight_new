...
@section('subcontent')
        ...
        <div class="col-span-12 lg:col-span-8 2xl:col-span-9">
            ...
            <div class="intro-y box lg:mt-5">
                <div class="flex items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
                    <h2 class="font-medium text-base mr-auto">Manage Users</h2>
                </div>
                <div class="p-5">
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        ...
                        <div class="mt-5 flex sm:mt-0 max-sm:hidden">
                            <x-base.button type="button" data-tw-toggle="modal" data-tw-target="#addUserModal" class="shadow-md add_btn" variant="primary" >
                    ...
                    <div class="scrollbar-hidden overflow-x-auto">
                        <div class="mt-3 sm:mt-5 gca_responsive" id="adminUserListTable" ></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    @include('app.superadmin.settings.admin-user.index-modals')
...
@pushOnce('scripts')
    @vite('resources/js/app/superadmin/settings/users.js')
@endPushOnce
...
<x-base.dialog id="companyInformationModal" staticBackdrop size="xl">
        ...
        <form method="post" action="#" id="companyInformationForm">
            ...
            <x-base.dialog.description class="">
                <div class="grid grid-cols-12 gap-2.5">
                    ...
                    <div class="col-span-12 sm:col-span-4 registrationWrap" style="display: {{ isset($company->business_type) && $company->business_type == 'Company' ? 'block' : 'none' }};">
...
<!-- BEGIN: Company Vat Modal Content -->
<x-base.dialog id="companyVATModal" staticBackdrop size="sm">
    <x-base.dialog.panel class="rounded-none">
        <form method="post" action="#" id="companyVATForm">
            <x-base.dialog.title>
                <h2 class="mr-auto text-base font-medium inline-flex items-center">VAT Registration</h2>
                <a class="absolute right-0 top-0 mr-3 mt-3" data-tw-dismiss="modal" href="#" ><x-base.lucide class="h-6 w-6 text-slate-400" icon="X" /></a>
            </x-base.dialog.title>
            <x-base.dialog.description class="">
                <div class="flex">
            ...
            <x-base.dialog.footer>
                <x-base.button class="mr-1 w-20" data-tw-dismiss="modal" type="button" variant="outline-secondary" ><x-base.lucide class="mr-2 h-4 w-4" icon="x-circle" />Cancel </x-base.button>
                <x-base.button class="w-auto" id="vtUpdateBtn" type="submit" variant="primary">
                    <x-base.lucide class="mr-2 h-4 w-4" icon="check-circle" />
                    Save
                    <x-base.loading-icon style="display: none;" class="ml-2 h-4 w-4 theLoader" color="#FFFFFF" icon="oval" />
                </x-base.button>
...
<!-- BEGIN: Quote Expire Date Content -->
<x-base.dialog id="quoteExpireDayModal" size="sm">
    <x-base.dialog.panel class="rounded-none">
        <form method="post" action="#" id="quoteExpireDayForm">
            <x-base.dialog.title>
                <h2 class="mr-auto text-base font-medium">Quote Expired In Days</h2>
            ...
            <x-base.dialog.description class="p-5">
                <div class="col-span-12 vatWrap">
                    <x-base.form-input value="{{ $company->quote_expired_in ?? '' }}" name="quote_expired_in" id="quote_expired_in" class="w-full" type="number" />
                    <div class="acc__input-error error-quote_expired_in text-danger text-xs mt-1" style="display: none;"></div>
                </div>
            </x-base.dialog.description>
            <x-base.dialog.footer>
                <x-base.button class="mr-1 w-20" data-tw-dismiss="modal" type="button" variant="outline-secondary" ><x-base.lucide class="mr-2 h-4 w-4" icon="x-circle" />Cancel </x-base.button>
                <x-base.button class="w-auto" id="sendQEIBtn" type="submit" variant="primary">
                    <x-base.lucide class="mr-2 h-4 w-4" icon="check-circle" />
                    Save
                    <x-base.loading-icon style="display: none;" class="ml-2 h-4 w-4 theLoader" color="#FFFFFF" icon="oval" />
                </x-base.button>
...
<!-- END: Quote Expire Date Modal Content -->
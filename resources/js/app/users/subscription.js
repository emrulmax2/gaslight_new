...
var subscriptionListTable = (function () {
    var _tableGen = function () {
        ...
        let user = $("#subscriptionListTable").attr('data-userid');
            ...
            columns: [
                {
                    ...
                    formatter(cell, formatterParams) { 
                        var html = '';
                            html += '<div>';
                                html += '<div class="whitespace-nowrap font-medium">'+cell.getData().start+' - '+cell.getData().end+'</div>';
                                html += '<div class="mt-0.5 whitespace-nowrap text-xs text-slate-500">'+cell.getData().package+'</div>';
                            html += '</div>';

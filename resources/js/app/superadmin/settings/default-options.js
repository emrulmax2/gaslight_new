...
(function(){
    ...
    $('#defaultOptionSettingForm').on('submit', function(e){
        e.preventDefault();
        const form = document.getElementById('defaultOptionSettingForm');
        ...
        axios({
            method: "post",
            url: route('superadmin.site.setting.default.opt.update'),
            data: form_data,

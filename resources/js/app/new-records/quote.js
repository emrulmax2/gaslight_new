...
(function(){
    ...
    $('#certificateForm').on('submit', function(e){
        ...
        let errors = {};
        if($theForm.find('[name="quote_number"]').val() == 0 || $theForm.find('[name="quote_number"]').val() == ''){
            errors['quote_number'] = 'Quote Number not generated.&nbsp;';
        }
